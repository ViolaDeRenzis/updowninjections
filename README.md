...
- The `chipav.dat` files contain the posterior samples of the averaged $\chi_{p}$ estimator. Samples for the  heuristic definition of $\chi_{p}$  are provided by default and can be found in `result.json`.
